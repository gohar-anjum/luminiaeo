// Hero configurations for app pages — use with `FeatureHero` from `@/components/FeatureHero`.
...
export const KEYWORD_RESEARCH_HERO = {
  ...
  stats: [
    { value: "500+", label: "keywords per search" },
    { value: "212", label: "countries supported" },
    { value: "3", label: "intent categories" },
  ...
  featurePoints: [
    {
      ...
      desc: "Know if keywords are informational, commercial, or transactional before you write a word.",
    },
    {
      icon: "📊",
      title: "Volume & CPC data",
      desc: "Real search volume and cost-per-click from DataForSEO, not estimates.",
    },
    {
      icon: "🤖",
      title: "AI visibility signals",
      desc: "See which keywords have the best chance of getting cited by AI answer engines.",
    },
    {
      icon: "📥",
      title: "CSV export",
      desc: "Export your keyword list with all metrics for use in your content strategy.",
    },
  ],
};
...
export const FAQ_GENERATOR_HERO = {
  ...
  featurePoints: [
    {
      icon: "🔍",
      title: "URL or topic input",
      desc: "Paste any live URL or describe a topic — we handle the research automatically.",
    },
    {
      icon: "✨",
      title: "AI-crafted answers",
      desc: "Answers are optimized for clarity and written to match how AI systems summarize information.",
    },
    {
      icon: "📋",
      title: "One-click copy",
      desc: "Copy individual FAQs or all at once, ready to paste into your CMS or structured data.",
    },
    {
      icon: "🌍",
      title: "Location-aware",
      desc: "Generate location-specific FAQs for any country or language market.",
    },
  ],
};
  ...
  featurePoints: [
    {
      ...
      desc: "Instant 0–100 relevance score with Excellent, Good, and Poor benchmarks.",
    },
    {
      icon: "🔑",
      title: "Keyword breakdown",
      desc: "See extraction and semantic scores for each keyword on your page.",
    },
    {
      icon: "💾",
      title: "Free repeat checks",
      desc: "Cached results mean re-analyzing the same URL costs zero credits.",
    },
    {
      icon: "📜",
      title: "Full history",
...
export const META_OPTIMIZER_HERO = {
  ...
  stats: [
    ...
    { value: "140–160", label: "ideal description chars" },
  ],
  featurePoints: [
    {
      icon: "🖊️",
      title: "AI-rewritten tags",
      desc: "Get keyword-optimized title and description suggestions tailored to your page content.",
    },
    {
      icon: "👁️",
      title: "Live SERP preview",
      desc: "See exactly how your page will appear in Google results before making changes.",
    },
    {
      icon: "💡",
      title: "Optimization tips",
      desc: "Actionable suggestions to close semantic gaps and improve click-through rates.",
    },
    {
      icon: "🔄",
      title: "Re-analyze anytime",
      desc: "Click re-analyze from history to instantly refresh your analysis with one click.",
    },
  ],
};
...
export const CONTENT_GENERATOR_HERO = {
  ...
  featurePoints: [
    {
      icon: "🏗️",
      title: "Full content structure",
      desc: "H2s, H3s, and section briefs laid out in a ready-to-write format.",
    },
    {
      icon: "🏷️",
      title: "Semantic keywords",
      desc: "LSI and semantic keyword recommendations embedded throughout the outline.",
    },
    {
      icon: "❓",
      title: "FAQ suggestions",
      desc: "Auto-generated FAQ questions based on your topic for structured data markup.",
    },
    {
      icon: "📤",
      title: "Export as markdown",
      desc: "Copy as Markdown, plain text, or download as JSON for your content team.",
    },
  ],
};
...
export const AI_VISIBILITY_HERO = {
  ...
  featurePoints: [
    {
      icon: "🤖",
      title: "GPT & Gemini tested",
      desc: "Your domain is checked against real AI-generated answers from both major platforms.",
    },
    {
      icon: "📊",
      title: "Citation score",
      desc: "Get a % score showing how often your domain appears in AI responses.",
    },
    {
      icon: "🏆",
      title: "Competitor comparison",
      desc: "See which competitor domains get cited instead of yours — and why.",
    },
    {
      icon: "🔁",
      title: "Retry failed queries",
      desc: "One-click retry for any queries that failed during the analysis run.",
    },
  ],
};
  ...
  featurePoints: [
    {
      ...
      desc: "Visualize your keyword cluster as a draggable, zoomable tree — click to expand branches.",
    },
    {
      icon: "🎯",
      title: "Intent labels",
      desc: "Every node is tagged: informational, commercial, transactional, or navigational.",
    },
    {
      icon: "📁",
      title: "CSV export",
      desc: "Download the full cluster as CSV with depth, intent, and child count for your team.",
    },
    {
      icon: "⚡",
      title: "Cached results",
      desc: "Re-running the same keyword returns instantly from cache at no extra cost.",
    },
  ],
};
  ...
  featurePoints: [
    {
      icon: "🚨",
      title: "Risk scoring",
      desc: "Every backlink scored as Low, Medium, or High risk with PBN probability percentage.",
    },
    {
      icon: "🔎",
      title: "10+ detection signals",
      desc: "Domain age, registrar, spam score, safe browsing status, and more analyzed per link.",
    },
    {
      icon: "🛡️",
      title: "Disavow-ready output",
      desc: "Export a filtered list of harmful backlinks to submit directly to Google Search Console.",
    },
    {
      icon: "📋",
      title: "Full audit trail",
      desc: "Registrar info, domain age, and reason codes for every flagged backlink.",
    },
  ],
};
...
export const DASHBOARD_HERO = {
  ...
  accentColor: "#6366f1",
  ctaLabel: "Open keyword research",
  stats: [
  ...
  featurePoints: [
    {
      ...
      desc: "See how credits map to each feature so you can plan campaigns confidently.",
    },
    {
      icon: "🧾",
      title: "Transaction history",
      desc: "Every purchase and deduction is listed with clear labels and timestamps.",
    },
    {
      icon: "⚡",
      title: "Fast navigation",
      desc: "Move from overview to any tool without losing context.",
    },
    {
      icon: "🔐",
      title: "Account-aware",
      desc: "Everything reflects your workspace, billing state, and entitlements.",
    },
  ],
};
  ...
  featurePoints: [
    {
      ...
      desc: "Keep domains, notes, and priorities together per initiative.",
    },
    {
      icon: "🌐",
      title: "Domain-first",
      desc: "See each property’s footprint at a glance.",
    },
    {
      icon: "📅",
      title: "Activity signals",
      desc: "Track last updates so nothing goes stale.",
    },
    {
      icon: "➕",
      title: "Quick create",
      desc: "Spin up a new project when you onboard a site.",
    },
  ],
};
  ...
  featurePoints: [
    {
      icon: "👤",
      title: "Profile",
      desc: "Keep name and email current for receipts and collaboration.",
    },
    {
      icon: "🔒",
      title: "Security",
      desc: "Rotate passwords on a cadence that matches your policy.",
    },
    {
      icon: "🔔",
      title: "Notifications",
      desc: "Decide which product emails you want to receive.",
    },
    {
      icon: "✅",
      title: "Saved preferences",
      desc: "Changes apply immediately across the app.",
    },
  ],
};
  ...
  featurePoints: [
    {
      ...
      desc: "Pick a bundle, pay once, and credits land on your account.",
    },
    {
      icon: "📈",
      title: "Transparent pricing",
      desc: "See per-feature costs before you run heavy jobs.",
    },
    {
      icon: "🧾",
      title: "History",
      desc: "Audit purchases alongside usage deductions.",
    },
    {
      icon: "↩️",
      title: "Support-friendly",
      desc: "Everything you need if finance asks for a paper trail.",
    },
  ],
};
  ...
  featurePoints: [
    {
      icon: "🎯",
      title: "What’s next",
      desc: "Head back to billing or jump straight into a tool while we finish syncing.",
    },
    {
      icon: "📬",
      title: "Receipt",
      desc: "Check your email for Stripe’s receipt and invoice details.",
    },
    {
      icon: "💬",
      title: "Need help?",
      desc: "If the balance looks off after a few minutes, refresh or contact support.",
    },
  ],
};
...
export const BILLING_CANCEL_HERO = {
  ...
  featurePoints: [
    {
      icon: "🛒",
      title: "Pick another bundle",
      desc: "Different credit amounts are available on the billing page.",
    },
    {
      icon: "🔁",
      title: "Instant retry",
      desc: "Restart checkout with the same or a new card.",
    },
    {
      icon: "📊",
      title: "Keep working",
      desc: "Use remaining credits while you decide on a top-up.",
    },
  ],
};
